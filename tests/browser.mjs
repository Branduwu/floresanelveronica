...
try {
  ...
  await page.getByRole('button',{name:'Descubrir la constelación de Karen Estephania'}).focus()
  await page.keyboard.press('Enter')
  ...
  check(await page.getByRole('img',{name:'Constelación Karen Estephania',exact:true}).isVisible(),'Nombre completo accesible mediante teclado')
  ...
  await page.getByRole('button',{name:'Abrir la carta para Karen Estephania'}).click()
  ...
  check(await page.getByRole('button',{name:'Abrir la carta para Karen Estephania'}).evaluate(el=>el===document.activeElement),'Escape cierra y devuelve el foco al sobre')
  ...
  await mobile.getByRole('button',{name:'Descubrir la constelación de Karen Estephania'}).tap()
  ...
  await mobile.getByRole('button',{name:'Abrir la carta para Karen Estephania'}).tap(); await mobile.waitForTimeout(1000)
  ...
  await mobile.getByRole('button',{name:'Abrir la carta para Karen Estephania'}).tap()
